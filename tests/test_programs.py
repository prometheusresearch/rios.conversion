...
###rios_redcap_tests = flatten([rios_redcap_tst(n) for n in rios_names])
rios_to_qualtrics_tsts = flatten([rios_tst(n) for n in rios_names])
...
def test_programs():
    ...
    tst_class(QualtricsFromRios, rios_to_qualtrics_tsts)
